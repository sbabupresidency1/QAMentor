...
import qa.qamentor.utils.AuthorDetails;
import qa.qamentor.utils.Directory;
import qa.qamentor.utils.Platform;
import qa.qamentor.utils.Steps;

import com.google.common.io.Files;

public class QAmentorReports {
	private static WebDriver driver;
	public static final int MAX_BAR_REPORTS = 10;
	public static final String MESSAGE = "QAMENTOR Reporter: Preparing Reports";
	...
	private static void stepFailureHandler(ITestResult ITestResult, Steps Steps, LogAs logAs)  {
		if (logAs == LogAs.FAILED)
		{
			...
			if (Directory.continueExecutionAfterStepFailed) {
				...
				throw new QAmentorReporterStepFailedException();
			}
			return;
		}
		buildReportData(Steps);
