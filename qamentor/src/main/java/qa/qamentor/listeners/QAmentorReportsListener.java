...
import qa.qamentor.exceptions.QAmentorReporterStepFailedException;
import qa.qamentor.utils.Attributes;
import qa.qamentor.utils.Directory;
import qa.qamentor.utils.Platform;
import qa.qamentor.utils.SettingsFile;
import qa.qamentor.utils.TestParameters;
import qa.qamentor.writers.ConsolidatedReportsPageWriter;
import qa.qamentor.writers.CurrentRunPageWriter;
import qa.qamentor.writers.HTMLDesignFilesJSWriter;
import qa.qamentor.writers.IndexPageWriter;
import qa.qamentor.writers.TestCaseReportsPageWriter;

public class QAmentorReportsListener implements ITestListener, IExecutionListener, IReporter, ISuiteListener {

	static Logger log = Logger.getLogger(QAmentorReportsListener.class.getName());
	int runCount = 0;
	...
	public void onTestSuccess(ITestResult result)  {
		try
		{
			...
			{
				result.setStatus(2);
				result.setThrowable(new QAmentorReporterStepFailedException());
	...
	public static void setPlatfromBrowserDetails(ITestResult paramITestResult)  {
		Platform.prepareDetails(QAmentorReports.getWebDriver());
	...
	public void generateIndexPage()  {
		...
		try
		{
			...
			IndexPageWriter.content(localPrintWriter, QAmentorReports.indexPageDescription);
