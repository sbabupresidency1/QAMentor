...
public class SettingsFile {
	...
	public static void initSettingsFile() throws QAmentorReporterException  {
	...
	public static void create(String paramString) throws QAmentorReporterException  {
		...
		{
			throw new QAmentorReporterException("Unable To Create Required Files for Custom Reports");
		}
	}

	public static void open() throws QAmentorReporterException  {
		...
		{
			throw new QAmentorReporterException("Settings File Not Available");
		}
		catch (IOException localIOException)
		{
			throw new QAmentorReporterException("Unable To Create Required Files for Custom Reports");
	...
	public static void close() throws QAmentorReporterException  {
		try
		{
	...
	public static void correctErrors() throws NumberFormatException, QAmentorReporterException  {
	...
	public static int getHighestTestCaseNumber() throws QAmentorReporterException  {
	...
	public static String get(String propertyKey) throws QAmentorReporterException  {
		open();
	...
	public static void set(String key, String value) throws QAmentorReporterException  {
		open();
