...
public class ExcelUtils {
	...
	public static String orLocatorMiddle;
			...
			if (row.getCell(3) != null) {
				...
				else if (orName.contains(","))
				{
					...
					if(orNameSplit.length==2){
						...
						orLocatorStart=orMap.get(orNameSplit[0]);
						orLocatorMiddle = orMap.get(orNameSplit[1]);
						orLocatorEnd=orMap.get(orNameSplit[2]);
						eachStep.setOrLocatorStart(orLocatorStart);
						eachStep.setOrLocatorMiddle(orLocatorMiddle);
						eachStep.setOrLocatorEnd(orLocatorEnd);
						eachStep.setOrLocator(orLocatorStart+orLocatorMiddle+orLocatorEnd);
					}					
				}
				else{
