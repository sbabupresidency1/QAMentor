...
public class CaseStep {
	...
	public String getOrLocatorMiddle() {
		return orLocatorMiddle;
	}
	
	public void setOrLocatorMiddle(String orLocatorMiddle) {
		this.orLocatorMiddle = orLocatorMiddle;
	}
	...
	private String orLocatorMiddle;
